...
return {
  {
    ...
    keys = {
      ...
      { "<leader>lt", "<cmd>Trouble diagnostics toggle filter.buf=0<CR>", desc = "Trouble" },
      { "<leader>lT", "<cmd>Trouble diagnostics toggle<CR>", desc = "Trouble [All]" },
      { "<leader>lq", "<cmd>Trouble qflist toggle<CR>", desc = "Quickfix" },
